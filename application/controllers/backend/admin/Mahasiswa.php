...
class Mahasiswa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('backend/admin/mahasiswa/modal-tambah');
        $this->load->view('backend/admin/mahasiswa/modal-ubah');
        $this->load->view('backend/admin/mahasiswa/modal-hapus');
        $this->load->view('backend/admin/layout/footer');
        $this->load->view('backend/admin/mahasiswa/index-js');
    }
    ...
    public function aksiHapus()
    {
        ...
        $mahasiswa = $this->MahasiswaModel->detail(['id' => $where['id']], 'mahasiswa');
        ...
        $proses = $this->MahasiswaModel->ubah($data, $where, 'mahasiswa');

        $this->MahasiswaModel->ubah($data, $where_user, 'user');

        echo json_encode($proses);
    }

    public function select_universitas()
    {
        $data = $this->db->get('ref_universitas')->result_array();
        echo json_encode($data);
    }
