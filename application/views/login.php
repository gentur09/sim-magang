            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none align-self-center d-lg-block">
                                <img class="img-fluid" src="<?= base_url('assets/image/undraw/undraw_web_developer.png') ?>" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user needs-validation" method="POST" action="<?= base_url('login/proses') ?>">
